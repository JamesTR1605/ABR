...
private:
    ...
    Persona* eliminarRecursivo(Persona* nodo, int id) {
        ...
        if (id < nodo->id) {
            ...
            // Verificar si es Dios o uno de los tatarabuelos (ID 0, 1, 2, 3, 4)
            if (id >= 0 && id <= 4) {
                cout << "Error: No se pueden eliminar la entidad suprema o los tatarabuelos fundadores (ID 0-4)." << endl;
                return nodo;
            }
...
public:
    ...
    void crearTatarabuelo(int id) {
        ...
        if (id < 1 || id > 4) {
            cout << "Error: Los tatarabuelos deben tener ID del 1 al 4" << endl;
            return;
        }
        
        if (buscarPersona(id) != NULL) {
            cout << "Error: Ya existe un tatarabuelo con ID " << id << endl;
            return;
        }
        ...
        cout << "Tatarabuelo creado exitosamente: " << nombre << endl;
    ...
    void mostrarPorGeneraciones() {
        ...
        cout << "\nTATARABUELOS (Generación 1):" << endl;
        for (int i = 1; i <= 4; i++) {
...
void mostrarMenu() {
    ...
    cout << "1. Crear tatarabuelo (ID 1-4)" << endl;
...
int main() {
    ...
    cout << "2. Luego crear los 4 tatarabuelos (ID 1-4) como descendientes de la entidad suprema" << endl;
    ...
    do {
        ...
        switch (opcion) {
            ...
            case 1: {
                cout << "\n=== CREAR TATARABUELO ===" << endl;
                cout << "Tatarabuelos disponibles:" << endl;
                cout << "ID 1: Primer Tatarabuelo" << endl;
                cout << "ID 2: Segunda Tatarabuela" << endl;
                cout << "ID 3: Tercer Tatarabuelo" << endl;
                cout << "ID 4: Cuarta Tatarabuela" << endl;
                
                int idTatarabuelo;
                cout << "Ingrese ID del tatarabuelo a crear (1-4): ";
                cin >> idTatarabuelo;
            ...
            case 2: {
                ...
                if (!arbol.verificarTatarabuelos()) {
                    cout << "Error: Primero debe crear los 4 tatarabuelos (ID 1-4)." << endl;
                    break;
                }
